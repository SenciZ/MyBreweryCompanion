...
(() => {
  ...
  app.use(express.static(path.join(__dirname, MODE === 'app' ? "../../frontend/build" : "../../admin/build")));
  ...
  app.get('/*', (req, res) => res.sendFile(path.join(__dirname, MODE === 'app' ? "../../frontend/build" : "../../admin/build", 'index.html')))
